...
const linking: LinkingOptions<RootStackParamList> = {
  ...
  config: {
    screens: {
      ...
      AccountConnections: 'accounts/:accountId/:mode',
      People: 'people',
      SavedPosts: 'saved',
      Drafts: 'drafts',
      ScheduledPosts: 'scheduled',
      Lists: 'lists',
      ListEditor: 'lists/edit',
      ListDetail: 'lists/:listId',
      Filters: 'filters',
      FilterEditor: 'filters/edit',
      StatusActions: 'status/:statusId/actions',
      Report: 'report',
      CrossAccountAction: 'status/:statusId/accounts',
